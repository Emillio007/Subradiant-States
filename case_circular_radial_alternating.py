...
lat = Lattice.Lattice()
lat.circlelat(N, d, distance_measure="inter", std_polarization="radial alternating", polarizations=None)

mytitle = "\n".join(wrap(r"$N = %s$ dipoles in circular lattice with $\frac{d}{\lambda0}=%s$ polarized radially alternating" % (N, a), 60))
