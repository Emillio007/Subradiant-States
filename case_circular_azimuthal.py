...
lat = Lattice.Lattice()
lat.circlelat(N, d, distance_measure="inter", std_polarization="azimuthal", polarizations=None)

mytitle = "\n".join(wrap(r"$N = %s$ dipoles in circular lattice with $\frac{d}{\lambda0}=%s$ polarized azimuthal" % (N, a), 60))
